...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SwordEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SwordEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SwordEngine";
		app.meta["name"] = "Friday Night Funkin': Sword Engine";
		app.meta["packageName"] = "com.swordcube.swordengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Sword Engine",
			width: 1280,
			x: null,
			y: null,
		};
