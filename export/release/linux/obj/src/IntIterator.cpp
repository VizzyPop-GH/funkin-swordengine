...
HX_DEFINE_STACK_FRAME(_hx_pos_0f48b3d71de16711_45_new,"IntIterator","new",0x5692054f,"IntIterator.new","/usr/bin/std/IntIterator.hx",45,0x197ca43f)
HX_LOCAL_STACK_FRAME(_hx_pos_0f48b3d71de16711_54_hasNext,"IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","/usr/bin/std/IntIterator.hx",54,0x197ca43f)
HX_LOCAL_STACK_FRAME(_hx_pos_0f48b3d71de16711_63_next,"IntIterator","next",0x6932a124,"IntIterator.next","/usr/bin/std/IntIterator.hx",63,0x197ca43f)
...
bool IntIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_0f48b3d71de16711_54_hasNext)
...
int IntIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_0f48b3d71de16711_63_next)
