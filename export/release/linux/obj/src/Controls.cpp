...
HXDLIN( 877)					_g = (_g + 1);
HXLINE( 879)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
HXDLIN( 864)			if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
...
HXDLIN( 905)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 907)				return ::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 908)				int id = device->_hx_getInt(0);
HXDLIN( 908)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 908)					if ((id != -1)) {
...
HXDLIN( 914)		if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
