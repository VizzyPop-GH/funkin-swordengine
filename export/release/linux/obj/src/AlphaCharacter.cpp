...
HXLINE( 434)			{
HXLINE( 434)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 434)				_g->set_y((_g->y + (( (Float)(45) ) * this->textSize)));
            			}
HXLINE( 435)			{
HXLINE( 435)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 435)				_g1->set_x((_g1->x + (( (Float)(5) ) * this->textSize)));
            			}
HXLINE( 436)			{
HXLINE( 436)				 ::flixel::math::FlxPoint _g2 = this->offset;
HXDLIN( 436)				_g2->set_x((_g2->x + (( (Float)(3) ) * this->textSize)));
            			}
...
HXLINE( 464)		{
HXLINE( 464)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 464)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXLINE( 477)			{
HXLINE( 477)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 477)				_g->set_y((_g->y - ( (Float)(50) )));
            			}
...
HXDLIN( 492)			_g->set_y((_g->y + (this->row * 60)));
            		}
HXLINE( 493)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 496)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 496)			_g->set_y((_g->y - ( (Float)(20) )));
HXDLIN( 496)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 499)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 499)			_g->set_y((_g->y - ( (Float)(16) )));
