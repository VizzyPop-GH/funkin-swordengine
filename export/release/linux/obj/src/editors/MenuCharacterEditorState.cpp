...
HXLINE( 291)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 291)				int _hx_tmp1 = 0;
HXDLIN( 291)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) + shiftMult);
...
HXLINE( 295)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 295)				int _hx_tmp1 = 0;
HXDLIN( 295)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) - shiftMult);
...
HXLINE( 299)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 299)				int _hx_tmp1 = 1;
HXDLIN( 299)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) + shiftMult);
...
HXLINE( 303)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 303)				int _hx_tmp1 = 1;
HXDLIN( 303)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) - shiftMult);
