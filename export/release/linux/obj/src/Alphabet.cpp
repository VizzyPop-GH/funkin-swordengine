...
HXLINE( 202)		 ::Alphabet _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 241)				 ::Alphabet _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)				_g->set_y((_g->y + this->LONG_TEXT_ADD));
            			}
            		}
...
HXLINE( 308)				{
HXLINE( 308)					 ::AlphaCharacter _g = letter;
HXDLIN( 308)					_g->set_x((_g->x + 90));
            				}
