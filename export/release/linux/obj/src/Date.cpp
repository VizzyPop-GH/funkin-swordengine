...
HX_DEFINE_STACK_FRAME(_hx_pos_57f305e1c8afa115_26_new,"Date","new",0x9aa26240,"Date.new","/usr/bin/std/cpp/_std/Date.hx",26,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/usr/bin/std/cpp/_std/Date.hx",30,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_34_getHours,"Date","getHours",0x256fe079,"Date.getHours","/usr/bin/std/cpp/_std/Date.hx",34,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","/usr/bin/std/cpp/_std/Date.hx",58,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_94_toString,"Date","toString",0xd2a372cc,"Date.toString","/usr/bin/std/cpp/_std/Date.hx",94,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_98_now,"Date","now",0x9aa26af6,"Date.now","/usr/bin/std/cpp/_std/Date.hx",98,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/usr/bin/std/cpp/_std/Date.hx",105,0xebaa30ef)
HX_LOCAL_STACK_FRAME(_hx_pos_57f305e1c8afa115_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/usr/bin/std/cpp/_std/Date.hx",112,0xebaa30ef)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_30_getTime)
...
int Date_obj::getHours(){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_34_getHours)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_58_getDay)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_57f305e1c8afa115_98_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_57f305e1c8afa115_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_57f305e1c8afa115_112_fromString)
