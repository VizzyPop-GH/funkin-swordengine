...
HX_DEFINE_STACK_FRAME(_hx_pos_42dd52d0e0faa196_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","/usr/bin/std/cpp/_std/sys/io/Process.hx",94,0xe78e6f55)
HX_LOCAL_STACK_FRAME(_hx_pos_42dd52d0e0faa196_114_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","/usr/bin/std/cpp/_std/sys/io/Process.hx",114,0xe78e6f55)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_42dd52d0e0faa196_94_new)
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_42dd52d0e0faa196_114_close)
