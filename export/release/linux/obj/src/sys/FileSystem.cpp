...
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/usr/bin/std/cpp/_std/sys/FileSystem.hx",31,0x84b745b0)
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/usr/bin/std/cpp/_std/sys/FileSystem.hx",38,0x84b745b0)
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/usr/bin/std/cpp/_std/sys/FileSystem.hx",75,0x84b745b0)
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/bin/std/cpp/_std/sys/FileSystem.hx",78,0x84b745b0)
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/bin/std/cpp/_std/sys/FileSystem.hx",93,0x84b745b0)
HX_LOCAL_STACK_FRAME(_hx_pos_afe3ce4ca9f077af_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/usr/bin/std/cpp/_std/sys/FileSystem.hx",101,0x84b745b0)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_93_deleteFile)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_afe3ce4ca9f077af_101_readDirectory)
