...
HXLINE( 367)		{
HXLINE( 367)			 ::flixel::math::FlxPoint _g1 = t->labelOffsets->__get(2).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 379)				 ::flixel::math::FlxPoint offset = _g3->__get(_g2).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 379)				_g2 = (_g2 + 1);
HXLINE( 381)				{
HXLINE( 381)					 ::flixel::math::FlxPoint _g = offset;
HXDLIN( 381)					_g->set_x((_g->x + 2));
            				}
            			}
            		}
HXLINE( 384)		return t;
