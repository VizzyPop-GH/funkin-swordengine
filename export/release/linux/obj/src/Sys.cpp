...
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_28_print,"Sys","print",0x483745ec,"Sys.print","/usr/bin/std/cpp/_std/Sys.hx",28,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_32_println,"Sys","println",0x3905f76e,"Sys.println","/usr/bin/std/cpp/_std/Sys.hx",32,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_56_args,"Sys","args",0xeaeddc7e,"Sys.args","/usr/bin/std/cpp/_std/Sys.hx",56,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_59_getEnv,"Sys","getEnv",0xd9e05658,"Sys.getEnv","/usr/bin/std/cpp/_std/Sys.hx",59,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_71_sleep,"Sys","sleep",0xfe70aad6,"Sys.sleep","/usr/bin/std/cpp/_std/Sys.hx",71,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_79_getCwd,"Sys","getCwd",0xd9ded99b,"Sys.getCwd","/usr/bin/std/cpp/_std/Sys.hx",79,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_83_setCwd,"Sys","setCwd",0xa6272e0f,"Sys.setCwd","/usr/bin/std/cpp/_std/Sys.hx",83,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_87_systemName,"Sys","systemName",0xbea5b6bb,"Sys.systemName","/usr/bin/std/cpp/_std/Sys.hx",87,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_91_command,"Sys","command",0x363f8cca,"Sys.command","/usr/bin/std/cpp/_std/Sys.hx",91,0x274d6112)
HX_LOCAL_STACK_FRAME(_hx_pos_f8b9c631b3e31a49_109_exit,"Sys","exit",0xed97463f,"Sys.exit","/usr/bin/std/cpp/_std/Sys.hx",109,0x274d6112)
...
void Sys_obj::print( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_28_print)
...
void Sys_obj::println( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_32_println)
...
::Array< ::String > Sys_obj::args(){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_56_args)
...
::String Sys_obj::getEnv(::String s){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_59_getEnv)
...
void Sys_obj::sleep(Float seconds){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_71_sleep)
...
::String Sys_obj::getCwd(){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_79_getCwd)
...
void Sys_obj::setCwd(::String s){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_83_setCwd)
...
::String Sys_obj::systemName(){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_87_systemName)
...
int Sys_obj::command(::String cmd,::Array< ::String > args){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_91_command)
...
void Sys_obj::exit(int code){
            	HX_STACKFRAME(&_hx_pos_f8b9c631b3e31a49_109_exit)
