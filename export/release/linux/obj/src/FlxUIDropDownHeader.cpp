...
HXLINE( 586)		{
HXLINE( 586)			 ::flixel::math::FlxPoint _g = this->button->offset;
HXDLIN( 586)			_g->set_x((_g->x - ( (Float)((Width - this->button->frameWidth)) )));
            		}
HXLINE( 587)		this->button->set_x(this->offset->x);
HXLINE( 588)		{
HXLINE( 588)			 ::flixel::math::FlxPoint _g1 = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 588)			_g1->set_x((_g1->x + this->button->offset->x));
            		}
