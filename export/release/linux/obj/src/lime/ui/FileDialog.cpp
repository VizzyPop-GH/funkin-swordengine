...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_34_browse,"lime.ui.FileDialog","browse",0xc1264193,"lime.ui.FileDialog.browse","lime/ui/FileDialog.hx",34,0x296febf9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_120_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",120,0x296febf9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_159_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",159,0x296febf9)
namespace lime{
namespace ui{
...
bool FileDialog_obj::browse( ::lime::ui::FileDialogType type,::String filter,::String defaultPath,::String title){
            		HX_BEGIN_LOCAL_FUNC_S5(::hx::LocalFunc,_hx_Closure_0, ::lime::ui::FileDialogType,type, ::lime::_hx_system::BackgroundWorker,worker,::String,filter,::Array< ::String >,title1,::String,defaultPath) HXARGC(1)
...
HXLINE(  94)						_gthis->onCancel->dispatch();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_34_browse)
HXDLIN(  34)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
HXDLIN(  34)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(  41)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(type,worker,filter,title1,defaultPath)),null(),null());
...
HXLINE( 147)			_gthis->onCancel->dispatch();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_120_open)
HXDLIN( 120)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
HXDLIN( 120)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 192)			_gthis->onCancel->dispatch();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_159_save)
HXDLIN( 159)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
HXDLIN( 159)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
