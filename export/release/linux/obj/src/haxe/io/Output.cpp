...
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/usr/bin/std/haxe/io/Output.hx",47,0x1d4aa9df)
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/usr/bin/std/haxe/io/Output.hx",57,0x1d4aa9df)
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_92_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/usr/bin/std/haxe/io/Output.hx",92,0x1d4aa9df)
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_103_write,"haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","/usr/bin/std/haxe/io/Output.hx",103,0x1d4aa9df)
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_121_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/usr/bin/std/haxe/io/Output.hx",121,0x1d4aa9df)
HX_LOCAL_STACK_FRAME(_hx_pos_d9ae7d15fe80d651_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/usr/bin/std/haxe/io/Output.hx",278,0x1d4aa9df)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_92_close)
            	}
...
void Output_obj::write( ::haxe::io::Bytes s){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_103_write)
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_121_writeFullBytes)
...
void Output_obj::writeString(::String s, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_d9ae7d15fe80d651_278_writeString)
