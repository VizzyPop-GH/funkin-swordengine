...
HX_DEFINE_STACK_FRAME(_hx_pos_9e8a8bd90a8beffa_37_new,"haxe.ds.GenericCell_hscript_Token","new",0x1c0e2ea2,"haxe.ds.GenericCell_hscript_Token.new","/usr/bin/std/haxe/ds/GenericStack.hx",37,0x1ba84058)
namespace haxe{
namespace ds{

void GenericCell_hscript_Token_obj::__construct( ::hscript::Token elt, ::haxe::ds::GenericCell_hscript_Token next){
            	HX_STACKFRAME(&_hx_pos_9e8a8bd90a8beffa_37_new)
