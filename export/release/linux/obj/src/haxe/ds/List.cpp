...
HX_DEFINE_STACK_FRAME(_hx_pos_941e1b77f1d3e484_45_new,"haxe.ds.List","new",0x82be24e7,"haxe.ds.List.new","/usr/bin/std/haxe/ds/List.hx",45,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_53_add,"haxe.ds.List","add",0x82b446a8,"haxe.ds.List.add","/usr/bin/std/haxe/ds/List.hx",53,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_68_push,"haxe.ds.List","push",0xe500b373,"haxe.ds.List.push","/usr/bin/std/haxe/ds/List.hx",68,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_99_pop,"haxe.ds.List","pop",0x82bfb218,"haxe.ds.List.pop","/usr/bin/std/haxe/ds/List.hx",99,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_123_clear,"haxe.ds.List","clear",0xf96935d4,"haxe.ds.List.clear","/usr/bin/std/haxe/ds/List.hx",123,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_137_remove,"haxe.ds.List","remove",0x3f86961d,"haxe.ds.List.remove","/usr/bin/std/haxe/ds/List.hx",137,0xaa0a9ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_941e1b77f1d3e484_161_iterator,"haxe.ds.List","iterator",0x056d2c07,"haxe.ds.List.iterator","/usr/bin/std/haxe/ds/List.hx",161,0xaa0a9ccb)
namespace haxe{
namespace ds{

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_941e1b77f1d3e484_45_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_941e1b77f1d3e484_53_add)
...
void List_obj::push( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_941e1b77f1d3e484_68_push)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,push,(void))
 ...
 ::Dynamic List_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_941e1b77f1d3e484_99_pop)
...
void List_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_941e1b77f1d3e484_123_clear)
...
bool List_obj::remove( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_941e1b77f1d3e484_137_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,remove,return )
 ...
 ::haxe::ds::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_941e1b77f1d3e484_161_iterator)
