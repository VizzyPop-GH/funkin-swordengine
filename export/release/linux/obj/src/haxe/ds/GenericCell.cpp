...
HX_DEFINE_STACK_FRAME(_hx_pos_0cab01a7c56bc0df_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/usr/bin/std/haxe/ds/GenericStack.hx",37,0x1ba84058)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_0cab01a7c56bc0df_37_new)
