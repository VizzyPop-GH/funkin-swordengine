...
HX_DEFINE_STACK_FRAME(_hx_pos_3e1cb7958567f5bf_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/usr/bin/std/haxe/ds/List.hx",266,0xaa0a9ccb)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_3e1cb7958567f5bf_266_new)
