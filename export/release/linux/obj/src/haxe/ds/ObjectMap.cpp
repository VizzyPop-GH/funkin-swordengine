...
HX_DEFINE_STACK_FRAME(_hx_pos_efcd33871079f1c9_58_new,"haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",58,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_61_set,"haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",61,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_65_get,"haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",65,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_69_exists,"haxe.ds.ObjectMap","exists",0xc8930ca4,"haxe.ds.ObjectMap.exists","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",69,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_73_remove,"haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",73,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_76_keys,"haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",76,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_81_iterator,"haxe.ds.ObjectMap","iterator",0x61fc7ab6,"haxe.ds.ObjectMap.iterator","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",81,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_87_keyValueIterator,"haxe.ds.ObjectMap","keyValueIterator",0x5b9b0628,"haxe.ds.ObjectMap.keyValueIterator","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",87,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_98_toString,"haxe.ds.ObjectMap","toString",0x06d10174,"haxe.ds.ObjectMap.toString","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",98,0x5081b559)
HX_LOCAL_STACK_FRAME(_hx_pos_efcd33871079f1c9_103_clear,"haxe.ds.ObjectMap","clear",0xa0ca73c5,"haxe.ds.ObjectMap.clear","/usr/bin/std/cpp/_std/haxe/ds/ObjectMap.hx",103,0x5081b559)
namespace haxe{
namespace ds{

void ObjectMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_58_new)
            	}
...
void ObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_61_set)
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectMap_obj,set,(void))
 ...
 ::Dynamic ObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_65_get)
...
bool ObjectMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_69_exists)
...
bool ObjectMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_73_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectMap_obj,remove,return )
 ...
 ::Dynamic ObjectMap_obj::keys(){
            	HX_GC_STACKFRAME(&_hx_pos_efcd33871079f1c9_76_keys)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectMap_obj,keys,return )
 ...
 ::Dynamic ObjectMap_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_efcd33871079f1c9_81_iterator)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectMap_obj,iterator,return )
 ...
 ::Dynamic ObjectMap_obj::keyValueIterator(){
            	HX_GC_STACKFRAME(&_hx_pos_efcd33871079f1c9_87_keyValueIterator)
...
::String ObjectMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_98_toString)
...
void ObjectMap_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_efcd33871079f1c9_103_clear)
