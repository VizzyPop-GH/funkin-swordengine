...
HX_DEFINE_STACK_FRAME(_hx_pos_8739c4183f159555_58_new,"haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",58,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_61_set,"haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",61,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_65_get,"haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",65,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_69_exists,"haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",69,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_73_remove,"haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",73,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_76_keys,"haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",76,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_81_iterator,"haxe.ds.IntMap","iterator",0x4dc7ddd8,"haxe.ds.IntMap.iterator","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",81,0x2dfd0959)
HX_LOCAL_STACK_FRAME(_hx_pos_8739c4183f159555_87_keyValueIterator,"haxe.ds.IntMap","keyValueIterator",0xea115b4a,"haxe.ds.IntMap.keyValueIterator","/usr/bin/std/cpp/_std/haxe/ds/IntMap.hx",87,0x2dfd0959)
namespace haxe{
namespace ds{

void IntMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8739c4183f159555_58_new)
            	}
...
void IntMap_obj::set(int key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8739c4183f159555_61_set)
...
HX_DEFINE_DYNAMIC_FUNC2(IntMap_obj,set,(void))
 ...
 ::Dynamic IntMap_obj::get(int key){
            	HX_STACKFRAME(&_hx_pos_8739c4183f159555_65_get)
...
bool IntMap_obj::exists(int key){
            	HX_STACKFRAME(&_hx_pos_8739c4183f159555_69_exists)
...
bool IntMap_obj::remove(int key){
            	HX_STACKFRAME(&_hx_pos_8739c4183f159555_73_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(IntMap_obj,remove,return )
 ...
 ::Dynamic IntMap_obj::keys(){
            	HX_GC_STACKFRAME(&_hx_pos_8739c4183f159555_76_keys)
...
HX_DEFINE_DYNAMIC_FUNC0(IntMap_obj,keys,return )
 ...
 ::Dynamic IntMap_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_8739c4183f159555_81_iterator)
...
HX_DEFINE_DYNAMIC_FUNC0(IntMap_obj,iterator,return )
 ...
 ::Dynamic IntMap_obj::keyValueIterator(){
            	HX_GC_STACKFRAME(&_hx_pos_8739c4183f159555_87_keyValueIterator)
