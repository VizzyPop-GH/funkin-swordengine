...
HX_DEFINE_STACK_FRAME(_hx_pos_3c6478285c9a542d_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","/usr/bin/std/haxe/format/JsonParser.hx",51,0x77c4dd0a)
HX_LOCAL_STACK_FRAME(_hx_pos_3c6478285c9a542d_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","/usr/bin/std/haxe/format/JsonParser.hx",56,0x77c4dd0a)
HX_LOCAL_STACK_FRAME(_hx_pos_3c6478285c9a542d_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/usr/bin/std/haxe/format/JsonParser.hx",71,0x77c4dd0a)
HX_LOCAL_STACK_FRAME(_hx_pos_3c6478285c9a542d_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/usr/bin/std/haxe/format/JsonParser.hx",152,0x77c4dd0a)
HX_LOCAL_STACK_FRAME(_hx_pos_3c6478285c9a542d_312_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/usr/bin/std/haxe/format/JsonParser.hx",312,0x77c4dd0a)
HX_LOCAL_STACK_FRAME(_hx_pos_3c6478285c9a542d_318_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/usr/bin/std/haxe/format/JsonParser.hx",318,0x77c4dd0a)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_3c6478285c9a542d_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_3c6478285c9a542d_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_3c6478285c9a542d_71_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_3c6478285c9a542d_152_parseString)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_3c6478285c9a542d_312_invalidChar)
HXLINE( 313)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_3c6478285c9a542d_318_invalidNumber)
