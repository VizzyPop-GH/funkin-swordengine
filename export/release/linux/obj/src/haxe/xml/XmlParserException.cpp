...
HX_DEFINE_STACK_FRAME(_hx_pos_2864a4dd9f4534c7_75_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","/usr/bin/std/haxe/xml/Parser.hx",75,0x171858fc)
HX_LOCAL_STACK_FRAME(_hx_pos_2864a4dd9f4534c7_95_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","/usr/bin/std/haxe/xml/Parser.hx",95,0x171858fc)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_2864a4dd9f4534c7_75_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_2864a4dd9f4534c7_95_toString)
