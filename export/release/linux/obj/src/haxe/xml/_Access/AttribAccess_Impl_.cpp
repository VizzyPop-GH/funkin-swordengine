...
HX_LOCAL_STACK_FRAME(_hx_pos_4e94c11b07934eee_39_resolve,"haxe.xml._Access.AttribAccess_Impl_","resolve",0xf06df4f6,"haxe.xml._Access.AttribAccess_Impl_.resolve","/usr/bin/std/haxe/xml/Access.hx",39,0x34dc6957)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_4e94c11b07934eee_39_resolve)
