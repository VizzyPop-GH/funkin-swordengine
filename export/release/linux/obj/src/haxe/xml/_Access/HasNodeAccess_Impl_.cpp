...
HX_LOCAL_STACK_FRAME(_hx_pos_4d1f7944d5b8edec_69_resolve,"haxe.xml._Access.HasNodeAccess_Impl_","resolve",0x5a406854,"haxe.xml._Access.HasNodeAccess_Impl_.resolve","/usr/bin/std/haxe/xml/Access.hx",69,0x34dc6957)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasNodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_4d1f7944d5b8edec_69_resolve)
