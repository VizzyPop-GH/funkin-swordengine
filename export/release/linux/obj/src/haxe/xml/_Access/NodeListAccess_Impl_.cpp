...
HX_LOCAL_STACK_FRAME(_hx_pos_2edd3245ef81e1fc_75_resolve,"haxe.xml._Access.NodeListAccess_Impl_","resolve",0x07a0eeac,"haxe.xml._Access.NodeListAccess_Impl_.resolve","/usr/bin/std/haxe/xml/Access.hx",75,0x34dc6957)
namespace haxe{
namespace xml{
namespace _Access{
...
::Array< ::Dynamic> NodeListAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_2edd3245ef81e1fc_75_resolve)
