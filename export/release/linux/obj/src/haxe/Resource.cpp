...
HX_LOCAL_STACK_FRAME(_hx_pos_c73538abe847758b_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","/usr/bin/std/cpp/_std/haxe/Resource.hx",35,0x2a8d6c48)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_c73538abe847758b_35_getBytes)
