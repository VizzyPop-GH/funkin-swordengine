...
HX_DEFINE_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_99_new,"haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","/usr/bin/std/haxe/Unserializer.hx",99,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_125_setResolver,"haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","/usr/bin/std/haxe/Unserializer.hx",125,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_144_readDigits,"haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","/usr/bin/std/haxe/Unserializer.hx",144,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_169_readFloat,"haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","/usr/bin/std/haxe/Unserializer.hx",169,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_184_unserializeObject,"haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/usr/bin/std/haxe/Unserializer.hx",184,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_199_unserializeEnum,"haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/usr/bin/std/haxe/Unserializer.hx",199,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_231_unserialize,"haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/usr/bin/std/haxe/Unserializer.hx",231,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_72_initCodes,"haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","/usr/bin/std/haxe/Unserializer.hx",72,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_465_run,"haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/usr/bin/std/haxe/Unserializer.hx",465,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_65_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/bin/std/haxe/Unserializer.hx",65,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_67_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/bin/std/haxe/Unserializer.hx",67,0x939c7be8)
HX_LOCAL_STACK_FRAME(_hx_pos_093eff5cfcc1dcc2_70_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/bin/std/haxe/Unserializer.hx",70,0x939c7be8)
namespace haxe{

void Unserializer_obj::__construct(::String buf){
            	HX_GC_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_99_new)
...
void Unserializer_obj::setResolver( ::Dynamic r){
            	HX_GC_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_125_setResolver)
...
int Unserializer_obj::readDigits(){
            	HX_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_144_readDigits)
HXLINE( 145)		int k = 0;
...
Float Unserializer_obj::readFloat(){
            	HX_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_169_readFloat)
...
void Unserializer_obj::unserializeObject( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_184_unserializeObject)
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,unserializeObject,(void))
 ...
 ::Dynamic Unserializer_obj::unserializeEnum(::hx::Class edecl,::String tag){
            	HX_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_199_unserializeEnum)
...
HX_DEFINE_DYNAMIC_FUNC2(Unserializer_obj,unserializeEnum,return )
 ...
 ::Dynamic Unserializer_obj::unserialize(){
            	HX_GC_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_231_unserialize)
...
::Array< int > Unserializer_obj::initCodes(){
            	HX_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_72_initCodes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_093eff5cfcc1dcc2_465_run)
