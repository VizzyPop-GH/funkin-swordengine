...
HX_DEFINE_STACK_FRAME(_hx_pos_78f8400d61589294_33_new,"haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","/usr/bin/std/haxe/crypto/BaseCode.hx",33,0x017d92fd)
HX_LOCAL_STACK_FRAME(_hx_pos_78f8400d61589294_72_initTable,"haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","/usr/bin/std/haxe/crypto/BaseCode.hx",72,0x017d92fd)
HX_LOCAL_STACK_FRAME(_hx_pos_78f8400d61589294_81_decodeBytes,"haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","/usr/bin/std/haxe/crypto/BaseCode.hx",81,0x017d92fd)
namespace haxe{
namespace crypto{

void BaseCode_obj::__construct( ::haxe::io::Bytes base){
            	HX_STACKFRAME(&_hx_pos_78f8400d61589294_33_new)
...
void BaseCode_obj::initTable(){
            	HX_STACKFRAME(&_hx_pos_78f8400d61589294_72_initTable)
...
HX_DEFINE_DYNAMIC_FUNC0(BaseCode_obj,initTable,(void))
 ...
 ::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_78f8400d61589294_81_decodeBytes)
