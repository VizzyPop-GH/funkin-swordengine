...
HX_LOCAL_STACK_FRAME(_hx_pos_9827123e04eab4e2_12_saveStack,"haxe.NativeStackTrace","saveStack",0x471b27d9,"haxe.NativeStackTrace.saveStack","/usr/bin/std/cpp/_std/haxe/NativeStackTrace.hx",12,0x600ffe42)
HX_LOCAL_STACK_FRAME(_hx_pos_9827123e04eab4e2_25_toHaxe,"haxe.NativeStackTrace","toHaxe",0x6b36d173,"haxe.NativeStackTrace.toHaxe","/usr/bin/std/cpp/_std/haxe/NativeStackTrace.hx",25,0x600ffe42)
namespace haxe{
...
void NativeStackTrace_obj::saveStack( ::Dynamic exception){
            	HX_STACKFRAME(&_hx_pos_9827123e04eab4e2_12_saveStack)
            	}
...
::Array< ::Dynamic> NativeStackTrace_obj::toHaxe(::Array< ::String > native,::hx::Null< int >  __o_skip){
            	...
            	HX_STACKFRAME(&_hx_pos_9827123e04eab4e2_25_toHaxe)
