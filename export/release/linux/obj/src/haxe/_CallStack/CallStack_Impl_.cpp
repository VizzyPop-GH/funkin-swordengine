...
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_52_callStack,"haxe._CallStack.CallStack_Impl_","callStack",0x30d63cab,"haxe._CallStack.CallStack_Impl_.callStack","/usr/bin/std/haxe/CallStack.hx",52,0x0a970d9f)
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_63_exceptionStack,"haxe._CallStack.CallStack_Impl_","exceptionStack",0x933cbdf8,"haxe._CallStack.CallStack_Impl_.exceptionStack","/usr/bin/std/haxe/CallStack.hx",63,0x0a970d9f)
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_71_toString,"haxe._CallStack.CallStack_Impl_","toString",0xaff80ceb,"haxe._CallStack.CallStack_Impl_.toString","/usr/bin/std/haxe/CallStack.hx",71,0x0a970d9f)
static const ::String _hx_array_data_baffa80f_4[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_84_subtract,"haxe._CallStack.CallStack_Impl_","subtract",0x6f9ab153,"haxe._CallStack.CallStack_Impl_.subtract","/usr/bin/std/haxe/CallStack.hx",84,0x0a970d9f)
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_120_equalItems,"haxe._CallStack.CallStack_Impl_","equalItems",0xbce5e9ab,"haxe._CallStack.CallStack_Impl_.equalItems","/usr/bin/std/haxe/CallStack.hx",120,0x0a970d9f)
HX_LOCAL_STACK_FRAME(_hx_pos_f1bf4cd60f448645_156_itemToString,"haxe._CallStack.CallStack_Impl_","itemToString",0xddade49e,"haxe._CallStack.CallStack_Impl_.itemToString","/usr/bin/std/haxe/CallStack.hx",156,0x0a970d9f)
...
::Array< ::Dynamic> CallStack_Impl__obj::callStack(){
            	HX_STACKFRAME(&_hx_pos_f1bf4cd60f448645_52_callStack)
...
::Array< ::Dynamic> CallStack_Impl__obj::exceptionStack(::hx::Null< bool >  __o_fullStack){
            	...
            	HX_STACKFRAME(&_hx_pos_f1bf4cd60f448645_63_exceptionStack)
...
::String CallStack_Impl__obj::toString(::Array< ::Dynamic> stack){
            	HX_GC_STACKFRAME(&_hx_pos_f1bf4cd60f448645_71_toString)
...
::Array< ::Dynamic> CallStack_Impl__obj::subtract(::Array< ::Dynamic> this1,::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_f1bf4cd60f448645_84_subtract)
...
bool CallStack_Impl__obj::equalItems( ::haxe::StackItem item1, ::haxe::StackItem item2){
            	HX_STACKFRAME(&_hx_pos_f1bf4cd60f448645_120_equalItems)
...
void CallStack_Impl__obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_STACKFRAME(&_hx_pos_f1bf4cd60f448645_156_itemToString)
