...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("SwordEngine",3f,f7,58,89),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("swordcube",32,17,3e,cb));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("SwordEngine",3f,f7,58,89));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Sword Engine",d8,f5,20,55));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.swordcube.swordengine",16,8e,f6,e3));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Sword Engine",d8,f5,20,55))
